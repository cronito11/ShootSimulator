...
AShootSimulatorGameProjectile::AShootSimulatorGameProjectile() 
{
	...
	CollisionComp->OnComponentHit.AddDynamic(this, &AShootSimulatorGameProjectile::OnHit);		// set up a notification for when this component hits something blocking
